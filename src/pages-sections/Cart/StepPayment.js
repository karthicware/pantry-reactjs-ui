...
export default function StepPayment(props) {
    ...
    const payNow = (modeOfPay) => {
        setBlocking(true);
        axios
            .post(`/api/v1/my/order/place-order?addressId=${deliveryAddressId}&modeOfPay=${modeOfPay}`)
            .then(response => {
                setBlocking(false);
                ...
                const options = {
                    ...
                    currency: "INR",
                    name: "Nammanuts",
                    description: "Sarees Test Transaction",
                    image:
        ...
        <>
            ...
            <div className={classes.mainSubContainer}>
                <div className={classes.root}>
                    ...
                    >
                        <Tab style={{ border: '1px solid #EEE' }} label="Credit/ Debit Card, NetBanking, Wallets, UPI & Other Bankings" {...a11yProps(0)} />
                        <Tab style={{ border: '1px solid #EEE' }} label="Cash on Delivery" {...a11yProps(1)} />
                    </Tabs>
                    <TabPanel value={value} index={0}>
                        <GridContainer>
                            <GridItem>
                                <Typography variant="subtitle2">Credit/ Debit Card, NetBanking, Wallets, UPI & Other Bankings</Typography>
                            </GridItem>
                            <GridItem>
                                <Button color="warning" style={{ marginTop: 40 }} onClick={() => payNow('RZP')}>Pay Now</Button>
                            </GridItem>
                            <GridItem>
                                <Typography variant="caption">You will be redirected to payment gateway site to authorize payment</Typography>
                            </GridItem>
                        </GridContainer>
                    </TabPanel>
                    <TabPanel value={value} index={1}>
                        <GridContainer>
                            <GridItem>
                                ...
                                <Typography variant="caption">For safe, contactless, and hassle free delivery, pay using card/wallet/netbanking</Typography>
                            </GridItem>
                            <GridItem>
                                <Button color="warning" style={{ marginTop: 40 }} onClick={() => payNow('COD')}>Place Order</Button>
                            </GridItem>
                            <GridItem>
                                <Typography variant="caption">Pay when your order is delivered</Typography>
                            </GridItem>
                        </GridContainer>
                    </TabPanel>
                </div>
